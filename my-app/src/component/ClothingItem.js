    ...
    <>
      {
        <Card sx={{ maxWidth: 250, backgroundColor: `${backgroundColor}` }}>
          <CardActionArea
            onClick={
              (parent.type == "closet" && handleOpen) ||
              (parent.type == "laundry" && sendItemToCloset)
            }
          >
            <CardMedia
              component="img"
            ...
            />
            <CardContent>
              <Typography variant="h5" sx={{ fontFamily: "Caudex" }}>
                {" "}
        ...
        >
          <Box sx={style}>
            <div display="block">
              <Typography
                variant="h3"
                sx={{ fontFamily: "Caudex", marginTop: "5%" }}
              >
                {" "}
                <b>{capitalize(item.name)}</b>{" "}
              </Typography>
                        ...
                        <ListItem disablePadding>
                          <ListItemText disablePadding>
                            <ul sx={{ listStyleType: "circle" }}>
                              {generateDisplayTag(tag, "weather")}
                            </ul>
                          </ListItemText>
                        </ListItem>
                      </>
            ...
            <Stack direction="row" spacing={1}>
              <Button
                ...
                onClick={() => handleDelete([item, { edit: false }])}
              >
                Delete
              </Button>
              <Button
      ...
      <Modal open={addItemModal} onClose={handleCloseModal}>
        <Box sx={style}>
          ...
          <TextField
            ...
            label="Name of item"
            variant="standard"
            onChange={(newValue) => setItemName(newValue.target.value)}
          />
          ...
          <Button
            ...
            sx={{
              ...
              marginInline: "auto",
              fontFamily: "Caudex",
              backgroundColor: "rgb(248, 196, 180)",
              ": hover": { backgroundColor: "rgb(255, 180, 180)" },
            }}
          >
            Edit Item
          </Button>
