    ...
    return (
      <>
        <Grid container justifyContent={"center"} sx={{ pt: 10 }}>
          <Card
            variant={"outlined"}
            sx={{ maxWidth: 800, px: 5, backgroundColor: "rgb(156, 180, 204)" }}
          >
            <CardContent>
              <Typography
                variant="h4"
                textAlign={"center"}
                sx={{ color: "white", fontFamily: "Caudex", pt: 5 }}
              >
                {" "}
      ...
      return (
        <Box display="flex" justifyContent="space-between" sx={{ pt: 10 }}>
          <IconButton
            ...
            onClick={() => onRegenItem(i, piece.item_template, piece.id)}
          >
            <RefreshIcon />
          </IconButton>
          <Typography
            variant="h4"
            sx={{ color: "white", fontFamily: "Caudex", pt: 15 }}
          >
            {piece.name.charAt(0).toUpperCase() + piece.name.slice(1)}
          </Typography>
          <ClothingItem
            item={piece}
            parent={{ type: "laundry", updateFunction: {} }}
            userId={userId}
          ></ClothingItem>
        </Box>
      );
          ...
          >
            <CardContent>
              <Typography
                ...
                sx={{ color: "white", fontFamily: "Caudex", pt: 5 }}
              >
                Here is your generated outfit for today:{" "}
              </Typography>
              <IconButton
                color="primary"
                aria-label=""
                sx={{ justifyContent: "center" }}
                onClick={generateOutfitFunction}
              >
