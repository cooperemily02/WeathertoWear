    ...
    <>
      <Collapse in={openAlert}>
        ...
        >
          {severity == "success"
            ...
            : "Could not add item. Please try again or submit a trouble ticket."}
        </Alert>
      </Collapse>
      <div
        style={{
      ...
      >
        <Button
          ...
          sx={{
            margin: "10px",
            backgroundColor: "rgb(211, 206, 223)",
            color: "rgb(105,105,105)",
            hover: { backgroundColor: "rgb(195, 184, 222)" },
          }}
        >
          Add Item
        </Button>
                  ...
                  {clothingItems.map((item, index) => (
                    <Grid item xs={2} sm={4} md={4} key={index}>
                      <ClothingItem
                        ...
                        parent={{
                          type: "closet",
                          updateFunction: fetchClothingItems,
                        }}
                        optionsForType={optionsForType}
                        optionsForWeather={optionsForWeather}
                        userId={userId}
                      ></ClothingItem>
                    </Grid>
                  ))}
          ...
          <Stack direction="row">
            ...
            <Stack direction="column">
              ...
              <TextField
                ...
                variant="standard"
                onChange={(newValue) =>
                  handleChangeItemName(newValue.target.value)
                }
              />
